...
TEXTS = {
    'ru': {
        ...
        'owner_ask_car_brand': "🚗 Введите марку и модель автомобиля на латинице (например, Toyota Camry).",
        ...
        'invalid_car_brand_cyrillic': "❗️*Ошибка.* Пожалуйста, введите марку и модель автомобиля, используя только *латинские буквы* (A-Z). Например: `Toyota Camry`.",
    ...
    'tj': {
        ...
        'invalid_car_brand_cyrillic': "❗️*Хатогӣ.* Лутфан, марка ва модели мошинро танҳо бо *ҳарфҳои лотинӣ* (A-Z) ворид кунед. Масалан: `Toyota Camry`.",
    ...
    def _handle_stateful_message(self, message):
        ...
        if state == State.AWAITING_NAME:
            ...
            if re.search('[а-яА-Я]', text):
                # Если кириллица найдена, отправляем сообщение об ошибке
                send_message(chat_id, get_text('invalid_car_brand_cyrillic', chat_id), reply_markup=self.get_back_cancel_keyboard(chat_id))
            else:
                # Если кириллицы нет, сохраняем данные и переходим к следующему шагу
                data['car_brand'] = text
